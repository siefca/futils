...
* **[`futils.utils/`](#futils.utils)**
  ...
  * [`mapply`](#mapply) – works like `clojure.core/apply` but on named arguments.
"
...
[[:subsubsection {:title "Usage examples" :tag "argc-usage-ex"}]]
...
[[:subsubsection {:title "Usage examples" :tag "relax-usage-ex"}]]
...
[[:subsubsection {:title "Usage examples" :tag "nameize-usage-ex"}]]
...
[[:subsubsection {:title "Usage examples" :tag "frepeat-usage-ex"}]]
[[:file {:src "test/futils/utils/frepeat.clj"}]]

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

[[:subsection {:title "mapply" :tag "mapply"}]]
...
[[:subsubsection {:title "Usage examples" :tag "mapply-usage-ex"}]]
